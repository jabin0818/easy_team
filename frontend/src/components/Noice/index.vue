...
<template>
  <div class="drawer drawer-end z-[100]">
    <input id="my-drawer" type="checkbox" class="drawer-toggle" v-model="props.visible" />
    <div class="drawer-content">
      <!-- Page content here -->
      <!-- <label for="my-drawer" class="btn btn-primary drawer-button">Open drawer</label> -->
    </div>
    <div class="drawer-side">
      <label class="drawer-overlay cursor-default" @click="emit('changeVisible')"></label>
      <!-- 消息列表 -->
      <div class="w-full">
        <div class="absolute right-0 h-screen overflow-y-auto bg-gray-50 p-8 2xl:w-4/12">
          <div class="flex items-center justify-between">
            <p tabindex="0" class="text-2xl font-semibold leading-6 text-gray-800 focus:outline-none">Notifications</p>
            <button
              role="button"
          ...
          <div class="mt-8 flex w-full rounded bg-white p-3">
            ...
            <div class="pl-3">
              <p tabindex="0" class="text-sm leading-none focus:outline-none">
                <span class="text-indigo-700">James Doe</span> favourited an <span class="text-indigo-700">item</span>
              </p>
          ...
          <div class="mt-4 flex w-full flex-shrink-0 rounded bg-white p-3 shadow">
            ...
            <div class="w-full pl-3">
              <div class="flex w-full items-center justify-between">
                ...
                <div tabindex="0" aria-label="close icon" role="button" class="cursor-pointer focus:outline-none">
          ...
          <div class="mt-4 flex w-full items-center rounded bg-red-100 p-3">
            ...
            <div class="flex w-full items-center justify-between pl-3">
              <p tabindex="0" class="text-sm leading-none text-red-700 focus:outline-none">
          ...
          <div class="mt-8 flex w-full items-center rounded bg-green-100 p-3">
            ...
            <div class="w-full pl-3">
              <div class="flex items-center justify-between">
                <p tabindex="0" class="text-sm leading-none text-green-700 focus:outline-none">
